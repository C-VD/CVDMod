...
def main():
  ...
  plistpath = scriptpath + "/resources/CVDMod-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/CVDMod-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/CVDMod-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/CVDMod-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/CVDMod-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/CVDMod-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/CVDMod.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/CVDMod.iss",inplace=1):
